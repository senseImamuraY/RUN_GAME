...
namespace PathCreation.Utility {
    ...
    public static class CubicBezierUtility {
        ...
        /// これはもともとあったベジェ曲線を2つに分けただけで、２つをくっつければ元に戻る
        ...
        // 与えられた4つの点（p0, p1, p2, p3）に基づいて3次ベジェ曲線の長さを大まかに推定する関数
        ...
        public static List<float> ExtremePointTimes (Vector3 p0, Vector3 p1, Vector3 p2, Vector3 p3) {
            ...
            // find stationary points on each axis
            // 各軸に対して極値の時のtを求める(0~1の範囲内)でxy,yz,zx平面それぞれに解の公式を適用)
